   ...
   <div class="container-fluid">
      <div class="row">
         <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
               <h4 class="mb-sm-0 font-size-18">Team Network</h4>
      ...
      <div class="row">
         <div class="col-12">
            <div class="card">
               <div class="card-body">
                  <h4 class="card-title">Teams Network</h4>
                  <div class="body genealogy-body genealogy-scroll">
                     <div class="genealogy-tree">
                        <ul>
                           @foreach($customer as $key => $data_1)
                           <li>
                              <a href="{{route('customer.treeview',[$data_1->user->id])}}">
                              ...
                              <ul class="active">
                                 ...
                                 <li>
                                    <a href="{{route('customer.treeview',[$data_2->user->id])}}">
                                       <div class="d-flex" style="box-shadow: 5px 5px 10px #888888;border-radius: 5px; padding: 10px;">
                                          <div class="align-self-center me-3">
                                             <i class="mdi mdi-circle text-success font-size-10"></i>
                                          </div>
                                    ...
                                    <ul>
                                       ...
                                       <li>
                                          <a href="{{route('customer.treeview',[$data_3->user->id])}}">
                                             <div class="d-flex" style="box-shadow: 5px 5px 10px #888888;border-radius: 5px; padding: 10px;">
                                                <div class="align-self-center me-3">
                                                   <i class="mdi mdi-circle text-success font-size-10"></i>
                                                </div>

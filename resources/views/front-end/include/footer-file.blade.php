         ...
         <div class="container">
            <div class="row">
               <div class="col-sm-6 col-lg-4 mb-4">
                  ...
                  <img src="{{ static_asset('front-end/img/logo-white.png')}}" class="mr-3" alt="Footer logo">
                  </a>
            ...
            <div class="row">
               <div class="col p-3">
                  <div class="d-flex text-center justify-content-center align-items-center">
                     <p class="copyright pb-0 mb-0"> Copyrights © 2022. All
                        rights reserved by
                        <a href="https://stacksolution.in" target="_blank">Stack Solution</a>
                     </p>
                  </div>
               </div>
            </div>
